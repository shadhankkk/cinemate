...
export const UserProfile = () => {
  ...
  const createReviews = async(reviewArr) => {
        ...
        <div className="flex flex-col items-center mt-[50px] mb-[50px] bg-gray-900 bg-opacity-20 w-[1300px] h-[800px] outline outline-yellow-500 rounded-[50px] ml-[3px] mr-[50px]">
          <div className="flex items-center h-[300px] ml-[0px]">
            <div className="ml-[-430px]">
              <Link to={filmPage}>
                <img src={movieCoverUrl} className="hover:opacity-80 h-[300px] max-w-[220px] object-contain p-[15px] rounded-[40px] mr-[20px]"></img>
              </Link>
            </div>
          ...
          <div className="w-[1170px] truncate px-[20px] pt-[5px] underline underline-offset-[10px] mr-[120px] text-[40px] text-yellow-400 decoration-gray-500 w-[1000px]">
            {reviewTitle}
          </div>
          <div className="break-all">
            <div className="overflow-auto text-[24px] p-[20px] rounded-b-[50px] w-[1290px] h-[400px] p-[20px] bg-blue-900 bg-opacity-0">
              {review}
            </div>
          </div>
        </div>
    ...
    setUserReviews(await Promise.all(reviewArr.map(review => createOneReview(review))));
  }
